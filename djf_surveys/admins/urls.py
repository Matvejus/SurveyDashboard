...
urlpatterns = [
    ...
    path('summary/survey/<int:survey_pk>/dimension/<int:dimension_id>/', admin_views.SummaryResponseSurveyView.as_view(), name='admin_dimension_summary'),
    path('summary/survey/<int:survey_pk>/sub-dimension/<int:sub_dimension_id>/', admin_views.SummaryResponseSurveyView.as_view(), name='admin_sub_dimension_summary'),
