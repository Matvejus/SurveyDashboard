...
class CustomUser(AbstractUser):
    ...
    organization = models.ForeignKey('organization.OrgProfile', on_delete=models.SET_NULL, related_name='users')
    collaboration_network = models.ForeignKey('organization.CollaborationNetwork', on_delete=models.SET_NULL)
