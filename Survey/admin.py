...
class SurveyAdmin(admin.ModelAdmin):
    list_display = ['survey_id', 'survey_name', 'description', 'start_date',
                    'end_date', 'min_responses', 'max_responses', 'survey_status']
...
class QuestionAdmin(admin.ModelAdmin):
    list_display = ['question_id', 'question_order',
                    'question_text', 'is_mandatory', 'question_type']
...
class ResponseAdmin(admin.ModelAdmin):
    list_display = ['response_id', 'respondent',
                    'survey', 'begin_date', 'end_date']
